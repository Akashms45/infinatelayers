...
const users = [
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1618331835717-801e976710b2?auto=format&fit=crop&q=80&w=400',
  ...
  },
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1563207153-f404bf40d3a5?auto=format&fit=crop&q=80&w=400',
  ...
  },
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1618172193622-ae2d025f4032?auto=format&fit=crop&q=80&w=400'
    ]
  }
];
    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="flex justify-between items-center mb-12 px-2">
          ...
          <button className="px-6 py-2.5 rounded-full border border-[#8C7AF0] text-[#5200FF] font-semibold text-[15px] hover:bg-[#5200FF] hover:text-white transition-colors shadow-sm">
            View all
          </button>
        </div>
