    ...
    <>
      ...
      <header className="navbar relative z-50 pt-8 pb-4">
        <div className="container-logit w-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-10 bg-white px-6 relative z-10">
            ...
            <a href="#calculator" className="text-[14px] font-semibold text-[#666666] hover:text-[#111111] transition-colors">Product</a>
            <a href="#trusted" className="text-[14px] font-semibold text-[#666666] hover:text-[#111111] transition-colors">Resources</a>
          </nav>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-[80px] left-0 w-full bg-white z-50 border-b border-[#E0E0E0] shadow-lg py-6 px-8 flex flex-col gap-4">
          ...
          <a href="#calculator" className="text-[16px] font-semibold py-1" onClick={() => setMobileMenuOpen(false)}>Product</a>
          <a href="#trusted" className="text-[16px] font-semibold py-1" onClick={() => setMobileMenuOpen(false)}>Resources</a>
        </div>
      )}
    </>
  );
